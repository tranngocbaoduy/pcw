# Generated by Django 3.2.15 on 2022-10-01 05:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "agency",
                    models.CharField(blank=True, max_length=512, verbose_name="Agency"),
                ),
                (
                    "base_encoded_url",
                    models.CharField(max_length=512, verbose_name="Encode URL"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_using_proxy",
                    models.BooleanField(default=False, verbose_name="Using Proxy"),
                ),
                (
                    "limit_per_request",
                    models.IntegerField(default=30, verbose_name="Limit per page"),
                ),
                (
                    "start_page",
                    models.IntegerField(default=0, verbose_name="Start page"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="",
                        max_length=256,
                        verbose_name="Base url item",
                    ),
                ),
                (
                    "domain",
                    models.CharField(default="", max_length=256, verbose_name="Domain"),
                ),
                (
                    "agency",
                    models.CharField(default="", max_length=256, verbose_name="Agency"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "spider",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="crawler.spider"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="crawler.ScraperSpider", to="crawler.Spider"
            ),
        ),
        migrations.CreateModel(
            name="Product",
            fields=[
                ...
                (
                    "clean_name",
                    models.CharField(max_length=256, verbose_name="Clean Name"),
                ),
                ("url", models.CharField(max_length=512, verbose_name="URL")),
                (
                    "base_encoded_url",
                ...
                (
                    "brand",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="crawler.brand"
                    ),
                ),
                (
                    "category",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="crawler.category"
            ),
        ),
    ]
