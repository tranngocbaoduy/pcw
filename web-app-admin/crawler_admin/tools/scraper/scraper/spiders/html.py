...
class HtmlSpider(scrapy.Spider):
    ...
    def __init__(self, *a, **kwargs):
        ...
        self.CLASS_PARENT = '.product' #self.spider.spider.class_parent
    ...
    def parse(self, response):  
        ...
        print('len',len(sel_item_urls)) 
        print('sel_item_urls',sel_item_urls) 

        parser_url = self.parsers.get(name='name')
        print('parser_url',parser_url.selector_type, parser_url.selector)
        news_page_link = self._parse_attribute(
            response,
            parser_url.selector_type,
            parser_url.selector
        )
        print('news_page_link',news_page_link)
