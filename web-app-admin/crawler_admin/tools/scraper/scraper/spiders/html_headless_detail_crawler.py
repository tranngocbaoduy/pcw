...
class HtmlHeadlessDetailCrawlSpiderBase(CrawlSpider): 
    name = "html_headless_detail_crawl_spider"
...
class HtmlHeadlessDetailCrawlSpiderClassFactory:
    @staticmethod
    def create_class(
        ...
        class HtmlHeadlessDetailCrawlSpider(HtmlHeadlessDetailCrawlSpiderBase):
            pass
